...
{
       0,   183,   183,   190,   191,   192,   193,   194,   195
};
#endif
...
#line 183 "p.y"
  ...
  case 3:
#line 190 "p.y"
    {(yyval)=suma(convertBinaryToDecimal((yyvsp[(1) - (3)])),convertBinaryToDecimal((yyvsp[(3) - (3)])));}
    break;

  case 4:
#line 191 "p.y"
    {(yyval)=resta(convertBinaryToDecimal((yyvsp[(1) - (3)])),convertBinaryToDecimal((yyvsp[(3) - (3)])));}
    break;

  case 5:
#line 192 "p.y"
    {(yyval)=multiplicacion(convertBinaryToDecimal((yyvsp[(1) - (3)])),convertBinaryToDecimal((yyvsp[(3) - (3)])));}
    break;

  case 6:
#line 193 "p.y"
    {(yyval)=division(convertBinaryToDecimal((yyvsp[(1) - (3)])),convertBinaryToDecimal((yyvsp[(3) - (3)])));}
    break;
